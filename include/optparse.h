...
namespace optparse {
    ...
    namespace detail {
        ...
        static std::string
        str_join_trans(const std::string &sep, InputIterator begin, InputIterator end, UnaryOperator op) {
            std::string buf;
    ...
    private:
        ...
        std::string format_help(const unsigned int indent = 2) const {
            ...
            if (help() != "") {
                std::string help_str = (get_default() != "") ? detail::str_replace(help(), "%default", get_default())
                                                             : help();
