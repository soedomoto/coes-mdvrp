...
class MDVRPSolver {
    private:
        ...
        const char * output(Population** population, int segment, int redundancy, int iterations, int itToMigrate, int itToInnnerMig, int nMig, int nUndoMig, bool maxMigrations, int seed);
    ...
    public:
        ...
        const char * solve(int iterations, int itToMigrate, int redudancy, int itToInnerMig, bool maxMigrations, int seed);
};
