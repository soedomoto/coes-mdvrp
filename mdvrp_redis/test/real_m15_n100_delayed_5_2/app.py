...
# Kondisi relatif homogen, art banyak, dengan geografi sulit semua
# Geographical delay
# Normal delay 5 menit +- 3 menit sebelum melakukan subscription
mu_delay = 60 * 60
sigma_delay = 3 * 60

# rata-rata wawancara 1 ruta = 71.58 menit
# stdev wawancara 1 ruta = 12.16 menit
lambda_interview_time = 71.58 * 60
sigma_interview_time = 12.16 * 60
# ======================================================================================================================
